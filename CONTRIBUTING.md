...
Branch protection, the default branch, and removing `main` are applied with
[`scripts/setup-repo.sh`](scripts/setup-repo.sh). See that file's header for
usage. They require repo-admin rights and the GitHub CLI (`gh`).
