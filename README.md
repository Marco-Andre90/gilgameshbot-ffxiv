...
6. On the **Advanced** tab, click **Publish to Discord** and confirm. This makes your branch table the [shared configuration](#changing-the-configuration-later) every member's plugin follows.
